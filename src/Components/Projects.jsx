...
const Projects = () => {
  return (
    <>
      ...
      <div className="z-[1] scrollAnim">
        <a
          href="https://aliyasahmed.github.io/WhatToDo/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <button className="text-white backdrop-blur-md rounded-lg p-4 shadow-lg shadow-shadow hover:bg-white hover:text-black hover:shadow-lg hover:shadow-white transition-all md:text-3xl">
            Todo App
          </button>
        </a>
      </div>
      ...
      <div className="z-[2] scrollAnim">
        <a
          ...
          rel="noopener noreferrer"
        >
          <button className="text-white backdrop-blur-lg rounded-lg p-4 shadow-lg shadow-shadow hover:bg-white hover:text-black hover:shadow-lg hover:shadow-white transition-all md:text-3xl">
            Netflix
          </button>
        </a>
      </div>
      ...
      <div className="z-[2] scrollAnim">
        <a
          href="https://aliyasahmed.github.io/projectX/"
          target="_blank"
          rel="noopener noreferrer"
        >
